...
class _ScrollControllerOverrideState extends State<ScrollControllerOverride> {
  ...
  void _setLockPosition() {
    if (widget.scrollController.hasClients && _currentDragDirection == DragDirection.up && widget.sheetLocation == SheetLocation.below || _currentDragDirection == DragDirection.down && widget.sheetLocation == SheetLocation.above) {
